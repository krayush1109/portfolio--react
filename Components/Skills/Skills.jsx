...
const Skills = () => {
  ...
  useEffect(() => {
    gsap.to("." + styles.skillTitle, {
      y: -100,
      opacity: 1,
      duration: 0.4,
      yoyo: true,
      scrollTrigger: {
        trigger: "." + styles.skillTitle,
        scroller: "body",
        start: "top 90%",
        end: "top 0",
        scrub: 2,
  ...
  return (
    <section className={`${styles.section} h-[100vh] w-full relative`} >
      <p className={`${styles.skillTitle} absolute opacity-0 -left-[5%] top-[52%] -translate-y-1/2 text-[10rem] uppercase text-transparent mix-blend-difference opacity-50`} >Skills</p>
      ...
      <div className={`${styles.skillIn} bg-green-100 h-[80%] pl-12 pr-6 py-8 shadow-orange-500 shadow-lg `}>
