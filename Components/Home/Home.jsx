        ...
        <>
            ...
            <section id='home' className='relative w-full h-[100vh] flex justify-around gap-12 pt-[10vh] overflow-hidden'>
                <div className="home-in w-1/2 h-[85%] flex flex-col justify-center gap-6 pr-10" id="home-in1">
                    ...
                    <h4 className='text-4xl font-[edo]' >A <span className='text-[#1cbe59]'> <span className={styles.creativeTxt}>Creative</span> Web Developer</span> from <span className={styles.indiaTxt}>INDIA</span></h4>
                    ...
                    <div className='foot-home-in flex items-center'>
                        <ButtonComp txt={"About Me"} addClass={"mr-12"} btnClass={styles.btnComp} btnBGClass={styles.btnBG} btnTxtClass={styles.btnTxt} />
                        <div className={`${styles.socialMedia} text-4xl flex gap-6`}>
                            <a href='https://www.linkedin.com/in/krayush1109/' target='_blank' className="ri-linkedin-box-fill"></a>
                            <a className="ri-github-fill" href='https://github.com/krayush1109' target='_blank'></a>
                            <ToolTip />
                        </div>
                    </div>
                </div>
                <div className="home-in w-1/2 h-[85%]  flex justify-center items-center " id="home-in2">
                    <div className={`${styles.avatarBG} h-[20vmax] w-[20vmax] overflow-hidden rounded-full shadow-pink-200 shadow-md`}>
                        <img src="/avatar.png" alt="Image NA" />
                    </div>
                </div>

                <div className={`${styles.downArrow} w-12 h-12 rounded-full bg-black opacity-40 absolute bottom-12 left-1/2 animate-bounce flex justify-center items-center`}>
