...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-between px-[11rem] z-200 h-[10vh] ' >
      <div id="logo" className='my-btn text-black' >Logo</div>
      <div id='nav-in' className='flex items-center gap-10 ' >
        ...
        <div className='my-btn py-2 px-6 w-[11rem] h-[2.75rem] border-[--primaryTxt] rounded-full border-[2px] duration-150 overflow-hidden relative flex justify-center items-center'>
          <div id="my-btnBG" className='bg-[--primaryTxt] absolute h-0 w-full bottom-0 left-0 transition-all duration-300'></div>
